...
### Задание 00 — Identification of stakeholders (Выявление заинтересованных сторон) 
**Для задачи 2:**
...
### Задание 01 — Building a Stakeholder Onion Diagram (Построение луковичной диаграммы) 
**Для задачи 2:**
...
### Задание 02 — Interests, needs, problems of stakeholders (Интересы, потребности, проблемы заинтересованных сторон) 
**Для каждой задачи:**
...
### Задание 03 — Building a glossary (Наполнение глоссария) <div id="54"></div>
**Для каждой задачи:**
